...
for scene in scenes:
    for alg_str in algorithms:
        ...
        data_path_single = f"{ROOT_PATH}/../z_experience_results/algo_details_t=1/single_{scene}_{alg_str}.csv"
        data_path_multi = f"{ROOT_PATH}/../z_experience_results/algo_details_t=1/multi_{scene}_{alg_str}.csv"
