...
scenes = [ 'RHS']  # 'RH', 'RHS', 'RW', 'VH'
colors = ['red', 'orange', 'green', 'blue']  # orange  brown

fig, axes = plt.subplots(len(difficulties), len(scenes), figsize=(20, 13))
axes = axes.flatten()
...
fig.legend(handles, labels, loc='lower center', ncol=len(algo_type), bbox_to_anchor=(0.5, -0.02), frameon=False)
plt.tight_layout(rect=[0, 0.08, 1, 1])
plt.tight_layout()
plt.savefig(f'./percentage_images/{percentages_type}.png',
