...
from btpg.algos.bt_planning.bt_planner_interface import BTPlannerInterface as HBTPExpInterface
...
def plot_percentage(percentages_type, difficulty, scene, algo_type, max_epoch, data_num, save_csv=False):
    ...
    for algo_str in algo_type:  # "opt_h0", "opt_h1", "obtea", "bfs"
        ...
        for i, (d,ld) in enumerate(zip(data[:data_num],llm_data[:data_num])):
            ...
            algo = BTPlannerInterface(env.behavior_lib, cur_cond_set=cur_cond_set,
                                ...
                                key_objects=[],
                                selected_algorithm=algo_str, mode="big",
                                llm_reflect=False, time_limit=5, #5
                                heuristic_choice=heuristic_choice,exp=True,exp_cost=False,output_just_best=False,
            ...
            # print("data:", i, "scene:",scene, "algo:",algo_str_complete)
            print(f"\x1b[32m {i} Goal:{goal_str} \n Executed {act_num} action steps\x1b[0m",
        ...
        save_path = f'{ROOT_PATH}/../z_experience_results/algo_details/{difficulty}_{scene}_{algo_str_complete}.csv'
        ...
        if save_csv == True:
            ...
            file_path = f'{ROOT_PATH}/../z_experience_results/percentage_output/{percentages_type}_{difficulty}_{scene}_{algo_str_complete}.csv'
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(f'{ROOT_PATH}/../z_experience_results/percentage_images/{percentages_type}_{difficulty}_{scene}.png', dpi=100)
    # plt.show()

max_epoch = 2000
# max_epoch = 500
data_num = 100
algo_type = ['hbtp']   # 'opt_h0','opt_h0_llm', 'obtea', 'bfs',      'opt_h1','weak'
