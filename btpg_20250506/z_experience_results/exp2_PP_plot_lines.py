...
def plot_percentage(percentages_type, difficulty, scene, algo_type,
    ...
    for algo_str in algo_type:
        file_path = f'{ROOT_PATH}/../z_experience_results/percentage_output/{percentages_type}_{difficulty}_{scene}_{algo_str}.csv'
...
# plt.tight_layout()
plt.savefig(f'{ROOT_PATH}/../z_experience_results/percentage_images/{percentages_type}_20250110.png',
