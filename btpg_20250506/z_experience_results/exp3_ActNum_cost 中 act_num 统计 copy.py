...
from btpg.envs.robothow.exec_lib.rh_action import RHAction
from btpg.envs.omimi.exec_lib.og_action import OGAction
from btpg.envs.robo_waiter.exec_lib.rw_action import RWAction
from btpg.envs.virtual_home.exec_lib.vh_action import VHAction
os.chdir(f'{ROOT_PATH}/../z_experience_results')
from btpg.algos.bt_autogen.tools  import calculate_priority_percentage
...
for difficulty in ['multi']:  # 'single', 'multi'
    for scene in ['RH', 'RHS', 'RW', 'VH']:  # 'RH', 'RHS', 'RW', 'VH'
        ...
        filename = f'{ROOT_PATH}/../z_experience_results/output_algo_act_num/{scene}_{difficulty}_maxep={max_epoch}_act_num.csv'
