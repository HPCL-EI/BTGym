...
if choose_max_exp:
    csv_file_path = f"{ROOT_PATH}/../z_experience_results/exp4_Attraction/1_only_changes_initial_t={exe_times}_False_{difficulty}_max_exp={max_exp}.csv"  # Define your CSV file path
else:
    csv_file_path = f"{ROOT_PATH}/../z_experience_results/exp4_Attraction/1_only_changes_initial_t={exe_times}_False_{difficulty}.csv"  # Define your CSV file path
