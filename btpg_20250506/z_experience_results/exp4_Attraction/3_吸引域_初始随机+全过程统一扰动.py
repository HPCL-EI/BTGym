...
algorithms = ['bfs','obtea','opt_h0','hbtp','opt_h0_llm']  # 'opt_h0', 'opt_h0_llm', 'obtea', 'bfs'      'dfs'
...
csv_file_path = f"{ROOT_PATH}/../z_experience_results/exp4_Attraction/3_initial_changes_all_{difficulty}_p={p}_t=5.csv"  # Define your CSV file path
