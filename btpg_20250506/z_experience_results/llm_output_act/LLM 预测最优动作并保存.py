...
for scene in ['VH']: #['RH', 'RHS', 'RW', 'VH']
    for difficulty in ["single"]: #'multi'
        ...
        # 读入数据
        output_path = f"{ROOT_PATH}/../z_experience_results/llm_data/{scene}_{difficulty}_100_llm_data.txt"
        default_prompt_file = f"{ROOT_PATH}/../z_experience_results/llm_output_act/prompt_{scene}.txt"
