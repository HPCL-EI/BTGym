...
from btgym.algos.bt_autogen.main_interface import BTPlannerInterface, collect_action_nodes
...
data_path = f"{ROOT_PATH}/../test/BT_EXP/DATA_BT_100_ori_yz_revby_cys.txt"
