...
print(data1[0])
analyze_data_tabular(data1,[45,1,1,1])
...
num_samples = 50  # Update this to the number of samples to process
...
plt.legend()
plt.grid(True)
plt.savefig(f'average_planning_time_plot_{time_str}.png')
plt.show()