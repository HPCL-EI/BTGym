...
csv_file_path_details = 'EXP_2_output_detailed_bt_data_small_100_bigerror_heuristic=0_noRandom.csv'
csv_file_path_summary = 'EXP_2_output_summary_bt_data_small_100_bigerror_heuristic=0_noRandom.csv'
