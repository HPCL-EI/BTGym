...
from tools import count_accuracy, identify_and_print_diffs, analyze_data_tabular,generate_custom_action_list,generate_custom_action_list_from_obj
import pickle
...
for heuristic_choice in [1]:
    ...
    for seed in range(5,10):
        ...
        for ind,d in enumerate(data):
            ...
            # 随机选择动作这里存在较大的随机性 ？？？！！！
            custom_action_list = generate_custom_action_list_from_obj(big_actions, 80, true_priority_act_set,d['Vital Objects'])
        ...
        csv_file_path_details = f'new_EXP_2_output_detailed_bt_data_small_100_bigerror_heuristic={heuristic_choice}_seed={seed}.csv'
        csv_file_path_summary = f'new_EXP_2_output_summary_bt_data_small_100_bigerror_heuristic={heuristic_choice}_seed={seed}.csv'
