...
# goal_set = [{'IsCut(apple)'}]
# priority_act_ls = ["Walk(cutleryknife)", "RightGrab(cutleryknife)", "Walk(apple)","Cut(apple)"]

goal_set = [{'IsClean(apple)'}]
priority_act_ls = ["Walk(apple)","RightGrab(apple)","Walk(faucet)","SwitchOn(faucet)","Wash(apple)"]
