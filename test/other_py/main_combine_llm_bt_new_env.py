...
goal_set = [set()]
# goal_set[0] |= {f"IsOpen({obj})" for obj in VHAction.CanOpenPlaces}
goal_set[0] |= {f"IsSwitchedOn({obj})" for obj in VHAction.HasSwitchObjects}

priority_act_ls = []
# priority_act_ls.extend(f"Walk({obj})" for obj in VHAction.CanOpenPlaces)
# priority_act_ls.extend(f"Open({obj})" for obj in VHAction.CanOpenPlaces)
priority_act_ls.extend(f"Walk({obj})" for obj in VHAction.HasSwitchObjects)
priority_act_ls.extend(f"SwitchedOn({obj})" for obj in VHAction.HasSwitchObjects)
