...
goal_str = 'IsIn_chicken_stove & IsIn_cutlets_stove & IsClose_stove & IsSwitchedOn_stove'
# goal_str = '(IsIn_chicken_stove | IsIn_cutlets_stove) & IsClose_stove & IsSwitchedOn_stove' # & IsOn_clothespile_bathroomcounter

# goal_str = '( (IsIn_chicken_stove & IsIn_cutlets_stove ) |  IsIn_poundcake_stove )  )'
#| IsIn_cutlets_stove)
# goal_str ='IsSwitchedOn_faucet' #RHS
# goal_str ='On_Coffee_Table1' # RW
print("goal_str:", goal_str)
# & IsOn_clothespile_bathroomcounter
key_objects = ["chicken","stove","clothespile","cutlets",'bathroomcounter']
key_predicates=["Walk","RightGrab","LeftGrab","RightPutIn","LeftPutIn","SwitchOn","Open","Close","RightPut"]
# key_objects = ["chicken","stove","cutlets"]
# key_predicates=["Walk","RightGrab","LeftGrab","RightPutIn","LeftPutIn","Open","Close"]
# priority_act_ls=[]
priority_act_ls = [
    "Walk(chicken)",
    "RightGrab(chicken)",
...
algo = BTExpInterface(env.behavior_lib, cur_cond_set=cur_cond_set,
                      ...
                      selected_algorithm="bfs", mode="small-predicate-objs",
                      act_tree_verbose=False, time_limit=30,
