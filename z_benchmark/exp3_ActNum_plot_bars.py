...
def plot_ratio(difficulty, scene, ax):
    ...
    # hbtp_file_path = f'{ROOT_PATH}/../z_benchmark/output_algo_act_num/hbtp_{scene}_{difficulty}_maxep={maxep}_act_num.csv'
    hbtp_file_path = f'{ROOT_PATH}/../z_benchmark/output_algo_act_num/{scene}_{difficulty}_maxep={maxep}_act_num.csv'
...
plt.tight_layout()
plt.savefig(f'{ROOT_PATH}/../z_benchmark/output_algo_act_num/{scene}_{difficulty}_maxep{maxep}.pdf',
